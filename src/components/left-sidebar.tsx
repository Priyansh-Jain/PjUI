          ...
          {sections.map((section) => (
            <div key={section.title}>
              <button
                ...
                className="flex items-center justify-between w-full text-left text-zinc-950 hover:text-white text-sm/6 font-[450] dark:text-white mb-2"
              >
                {/* class="text-sm/6 font-[450] text-zinc-950 dark:text-white" */}
                {section.title}
